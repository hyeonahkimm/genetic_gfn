...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=6 python run.py reinvent_ga --task simple --config_default 'hparams_ga.yaml' --wandb online --run_name rank3_rank3_gen3 --oracle $oralce --seed $seed
done
done
