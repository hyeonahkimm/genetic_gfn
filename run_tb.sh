...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=1 python run.py reinvent_ga --task simple --config_default 'hparams_tb.yaml' --wandb online --run_name rank3_prior_tb --oracle $oralce --seed $seed
done
done
