...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_quantile_blended.yaml' --wandb online --run_name quantile_blended --oracle $oralce --seed $seed
done
done
