...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_blended_gen2.yaml' --wandb online --run_name canonical_blended_gen2 --oracle $oralce --seed $seed
done
done
