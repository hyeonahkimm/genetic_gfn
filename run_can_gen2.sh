...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_can_gen2.yaml' --wandb online --run_name canonical_rank2xgen2_kl3_rank2 --oracle $oralce --seed $seed
done
done
