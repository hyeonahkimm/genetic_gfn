...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga_selfies --task simple --config_default 'hparams_gen2.yaml' --wandb online --run_name kl --oracle $oralce --seed $seed
done
done
