...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_mixed_gen3.yaml' --wandb online --run_name mixed_rank2xgen3_prior_rank2 --oracle $oralce --seed $seed
done
done
