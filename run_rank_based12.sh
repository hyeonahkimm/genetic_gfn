...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py genetic_gfn --task simple --oracle $oralce --wandb online --run_name rank3 --seed $seed --config_default 'hparams_graph_rank.yaml'
done
done
...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py genetic_gfn --task simple --oracle $oralce --wandb online --run_name large_rank --seed $seed --config_default 'hparams_graph_rank_large.yaml'
done
done