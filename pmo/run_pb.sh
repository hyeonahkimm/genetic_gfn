...
oracle_array=('celecoxib_rediscovery' 'troglitazone_rediscovery' \
...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py genetic_gfn --task simple --wandb online --seed $seed --oracle $oralce --config_default hparams_pb.yaml --run_name pb_beta150
done
done