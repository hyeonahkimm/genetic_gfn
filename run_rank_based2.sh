...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py genetic_gfn --task simple --oracle $oralce --wandb online --run_name no_blended_k16 --seed $seed --config_default 'hparams_graph_rank.yaml'
done
done
