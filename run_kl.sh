...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_kl.yaml' --wandb online --run_name 512_8x2_kl_rank_tuned --oracle $oralce --seed $seed
done
done
