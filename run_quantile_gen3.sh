...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_quantile_gen3.yaml' --wandb online --run_name quant_gen3_rank3 --oracle $oralce --seed $seed
done
done
