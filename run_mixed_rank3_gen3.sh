...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=1 python run.py reinvent_ga --task simple --config_default 'hparams_mixed_rank3_gen3.yaml' --wandb online --run_name mixed_rank3xgen3_prior_rank3 --oracle $oralce --seed $seed
done
done
