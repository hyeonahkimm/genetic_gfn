...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_ga_rank3.yaml' --wandb online --run_name rank3xgen1_rank3 --oracle $oralce --seed $seed
done
done
