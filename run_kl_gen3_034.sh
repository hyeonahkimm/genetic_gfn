...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_kl_gen3.yaml' --wandb online --run_name rank2xgen3_kl_rank2 --oracle $oralce --seed $seed
done
done
