...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga --task simple --config_default 'hparams_beta10_gen2.yaml' --wandb online --run_name beta10_gen2 --oracle $oralce --seed $seed
done
done
