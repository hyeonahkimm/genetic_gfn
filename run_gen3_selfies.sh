...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=0 python run.py reinvent_ga_selfies --task simple --config_default 'hparams_gen3.yaml' --wandb online --run_name gen3 --oracle $oralce --seed $seed
done
done
