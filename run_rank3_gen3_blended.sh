...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=1 python run.py reinvent_ga --task simple --config_default 'hparams_blended.yaml' --wandb online --run_name rank3_real_blended --oracle $oralce --seed $seed
done
done
